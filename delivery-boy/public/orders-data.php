                                        ...
                                        <div class="card col-md-3">
                                            <div class="card-body">
                                                <?php if ($item[8] == 'received') {
                                                    $active_status = '<label class="label label-primary">Reçu</label>';
                                                }
                                                if ($item[8] == 'processed') {
                                                    $active_status = '<label class="label label-info">En traitement</label>';
                                                }
                                                if ($item[8] == 'shipped') {
                                                    $active_status = '<label class="label label-warning">En cours de livraison</label>';
                                                }
                                                if ($item[8] == 'delivered') {
                                                    $active_status = '<label class="label label-success">Livré</label>';
                                                }
                                                if ($item[8] == 'returned') {
                                                    $active_status = '<label class="label label-danger">Annulé</label>';
                                                }
                                                if ($item[8] == 'cancelled') {
                                                    $active_status = '<label class="label label-danger">Retourné</label>';
                                                }
                                                if ($item[8] == 'awaiting_payment') {
                                                    $active_status = '<label class="label label-secondary">En attente de paiement</label>';
                                                }
                                                $array[] = $item[8];
