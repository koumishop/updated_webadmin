...
define('DOMAIN_URL', 'https://webadmin.koumishop.com/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
define('ALLOW_MODIFICATION', 1);
define('JWT_SECRET_KEY', '1234567890'); /* chnage to your secret key here set it to anything you like*/
...
class Database
{
    ...
    //private $db_name = "u382866440_koumishopv3"; 

      private $db_user = "u382866440_koumishopDev";  // Change as required
      private $db_pass = "Z4spJ6HZ32n3Qfa";  // Change as required
      private $db_name = "u382866440_koumishopv3";    // Change as required
