            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    <a href="orders.php">
                        ...
                        <span class="badge bg-success">
                            <?php
                            $query = "SELECT DISTINCT COUNT(o.id) AS number FROM orders o WHERE o.delivery_rank = ''";
                            $db->sql($query);
                            $result = $db->getResult();
                            $count = intval($result[0]['number']);
                            if ($count >= 0) {
                                if ($count > 10) {
                                    echo "10+";
                                } else if ($count == 0) {
                            ...
                            <span class="visually-hidden"> Order(s)</span>
                        </span>
                    </a>
                </li>
                <li>
                    <a href="services.php">
                        <i class="fa fa-bullseye"></i> <span>Services</span>
                    </a>
                </li>
                <li>
                    <a href="promotion.php">
                        <i class="fa fa-bullseye"></i> <span>Promotion</span>
                    </a>
                </li>
                <li class="treeview">
                    <a href="#">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <!-- <li><a href="delivery-charge.php"><i class="fa fa-reorder"></i> delivery-charge </a></li> -->
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
