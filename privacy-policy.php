                        ...
                        <form method="post" enctype="multipart/form-data">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <textarea rows="10" cols="10" class="form-control" name="privacy_policy" id="privacy_policy" required><?= $res[2]['value'] ?></textarea>
                                </div>
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="10" cols="10" class="form-control" name="terms_conditions" id="terms_conditions" required><?= $res[0]['value'] ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <!-- /.box-body -->
