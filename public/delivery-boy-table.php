                        ...
                        <!-- <div class="row">
                            <div class=" col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name='pincode_id[]' id='pincode_id' class='form-control' placeholder='Enter the pincode you want to allow delivery this delivery boy' multiple="multiple">
                        ...
                        <table class="table table-hover" data-toggle="table" id="delivery-boys" data-url="api-firebase/get-bootstrap-table-data.php?table=delivery-boys" data-page-list="[5, 10, 20, 50, 100, 200]" data-show-refresh="true" data-show-columns="true" data-side-pagination="server" data-pagination="true" data-search="true" data-trim-on-search="false" data-sort-name="id" data-sort-order="desc" data-show-export="true" data-export-types='["txt","excel"]' data-export-options='{"fileName": "delivery-boys-list-<?= date('d-m-Y') ?>","ignoreColumn": ["operate"] }'>
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="other_payment_information" data-visible="false" data-sortable="true">Other Payment Information</th>
                            ...
                            <!-- <div class="row">
                                <div class=" col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name='update_pincode_id[]' id='update_pincode_id' class='form-control' placeholder='Enter the pincode you want to allow delivery this delivery boy' multiple="multiple">
                                            <?php
