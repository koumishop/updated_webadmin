...
<section class="content-header">
	<h1>Delivery charge /<small><a href="home.php"><i class="fa fa-home"></i> Home</a></small></h1>
	<ol class="breadcrumb">
		<a class="btn btn-block btn-default" href="add-area.php"><i class="fa fa-plus-square"></i> Add New Delivery charge</a>
	</ol>
</section>
<?php
