...
$settings_app = $fn->get_settings('system_timezone', true);
$service_charge = $settings_app['service_charge'];
...
if (isset($_POST['btnEdit'])) {
    ...
    if ($permissions['products']['update'] == 1) {
        ...
        $serve_for = (isset($_POST['serve_for']) && $_POST['serve_for'] != '') ?$db->escapeString($fn->xss_clean($_POST['serve_for'])) : 0;
        ...
        // echo 'name:'.$name;
        if (!empty($name) && !empty($category_id) &&  !empty($serve_for) && !empty($subcategory_id) && empty($error['cancelable']) && empty($error)) {
            if (strpos($name, "'") !== false) {
            ...
            // $price = $tempo_price + (($tempo_price * $service_charge)/100);
            for ($i = 0; $i < $count; $i++) {
                if ($_POST['type'] == "packet") {
                    ...
                    $data = array(
                        ...
                        'price_original' => $db->escapeString($fn->xss_clean($_POST['packate_price'][$i])),
                        'price' => $db->escapeString($fn->xss_clean($_POST['packate_price'][$i])) + (($db->escapeString($fn->xss_clean($_POST['packate_price'][$i])) * $service_charge)/100),
                    ...
                    $data = array(
                        ...
                        'price_original' => $db->escapeString($fn->xss_clean($_POST['loose_price'][$i])),
                        'price' => $db->escapeString($fn->xss_clean($_POST['loose_price'][$i])) + (($db->escapeString($fn->xss_clean($_POST['loose_price'][$i]))* $service_charge)/100),
            ...
            if (
                ...
                for ($i = 0; $i < count($insert_packate_measurement); $i++) {
                    ...
                    $data = array(
                        ...
                        "price_original" => $db->escapeString($fn->xss_clean($_POST['insert_packate_price'][$i])),
                        "price" => $db->escapeString($fn->xss_clean($_POST['insert_packate_price'][$i])) + (($db->escapeString($fn->xss_clean($_POST['insert_packate_price'][$i]))* $service_charge)/100),
            ...
            if (
                ...
                for ($i = 0; $i < count($insert_loose_measurement); $i++) {
                    $data = array(
                        ...
                        "price_original" => $db->escapeString($fn->xss_clean($_POST['insert_loose_price'][$i])),
                        "price" => $db->escapeString($fn->xss_clean($_POST['insert_loose_price'][$i])) + (($db->escapeString($fn->xss_clean($_POST['insert_loose_price'][$i]))* $service_charge)/100),
                        ...
                        <div id="variations">
                            ...
                            ?>
                                    <div class="row packate_div">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group packate_div">
                                                <label for="price">Price (<?= $settings['currency'] ?>):</label> <i class="text-danger asterik">*</i> <input type="number" step="any" min="0" class="form-control" name="packate_price[]" id="packate_price" value='<?= $row['price_original']; ?>' required />
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group packate_div">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Sub Category :</label><i class="text-danger asterik">*</i> <?php echo isset($error['category_id']) ? $error['category_id'] : ''; ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <!-- <i class="text-danger asterik">*</i> <?php echo isset($error['description']) ? $error['description'] : ''; ?> -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="product_status" class="btn-group">
                                            <label class="btn btn-default" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                                <input type="radio" name="pr_status" value="0"> Desactive
                                            </label>
                                            <label class="btn btn-primary" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
