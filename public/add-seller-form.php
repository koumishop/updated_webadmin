                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    <div class="form-group">
                                        <label for="id_service_name">Service</label><?php echo isset($error['service_id']) ? $error['service_id'] : ''; ?>
                                        <select class="form-control" id="id_service_name" name="service_id" required>
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name='category_ids[]' id='category_ids' class='form-control' placeholder='Enter the category IDs you want to assign Seller' required multiple="multiple">
...
<script>
    $(document).on('change', '#id_service_name', function() {
        $.ajax({
            url: "public/db-operation.php",
            data: "service_id=" + $('#id_service_name').val() + "&change_service=1",
            method: "POST",
            success: function(data) {
                $('#category_ids').html("<option value=''>---Select Category---</option>" + data);
            }
        });
    });
