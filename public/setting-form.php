                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="number" class="form-control" name="service_charge" value="<?= $data['service_charge']; ?>"/>
                                </div>
                            </div>
                            <hr>
                            <hr>
                            <h4>Daily rate (<?= $settings['currency'] ?>) </h4>
                            <hr>
                            <div class="row">
                                <div class="form-group col-md-4">
                                    <label for="">Amount (<?= $settings['currency'] ?>)</label>
                                    <input type="number" class="form-control" name="daily_rate" value="<?= $data['daily_rate']?>"/>
                                </div>
                            </div>
                            <hr>
